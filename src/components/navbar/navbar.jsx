    ...
    return (
        <div className='nav'>
            <div className="navbar">
                ...
                <div className="right">
                    <Link to='/categories' className='right-nav'>Categories</Link>
                    <Link to='/register' className='right-nav'>REGISTER</Link>
                    <Link to='/login' className='right-nav'>LOGIN</Link>
                    <AccountCircleIcon id="account-btn" onClick={accountClick} />
                    <ul className={accountActive === true ? 'account-dropdown account-active' : 'account-dropdown'}>
            ...
            <div className={hamActive === true ? 'hamburger ham-active' : 'hamburger'}>
                <ul>
